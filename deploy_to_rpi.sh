...
echo ""
echo "Data will be collected twice weekly and saved to:"
echo "  ~/fear-greed-collector/fear_greed_data.csv"
echo ""
echo "To modify the collection schedule:"
echo "  1. SSH to the Pi: ssh $RPI_USER@$RPI_HOST"
echo "  2. Edit timer: sudo nano /etc/systemd/system/fear-greed-collector.timer"
echo "  3. Change OnCalendar lines (e.g., 'OnCalendar=daily' for daily collection)"
